# Generated by Django 5.1.6 on 2025-04-24 22:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_per_hour', models.DecimalField(decimal_places=2, default=150.0, max_digits=8)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('is_active', models.BooleanField(default=True)),
                ('carpark', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='reservations', to='accounts.carpark')),
            ],
        ),
        migrations.CreateModel(
            name='Payment',
            fields=[
                ...
                ('reservation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='payment', to='accounts.reservation')),
            ],
        ),
    ]
